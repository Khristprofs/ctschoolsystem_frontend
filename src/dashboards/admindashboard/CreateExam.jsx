...
const CreateExam = () => {
    ...
    const fetchFormData = async () => {
        try {
            const res = await axios.get(
                "http://localhost:3001/api/v1/admin/exam/form-data"
            );
    ...
    const handleSubmit = async (e) => {
        ...
        if (!selectedSubject || !selectedTeacher || !selectedClass || !selectedSession || !selectedTerm) {
            return alert("Fill all required fields");
        }

        try {
            await axios.post(
                "http://localhost:3001/api/v1/admin/academics/exams",
                {
                    title,
                    description,
            ...
            navigate("/admin/academics/exams");
        } catch (err) {
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-10 flex justify-center">
            <div className="bg-white w-full max-w-5xl rounded-2xl shadow-xl p-10">
                <h2 className="text-3xl font-bold mb-6">Create Exam</h2>
